...
async def test_acquire_graph_resources_not_occupied_gate():
    ...
    state.global_simulation_state.registry["Gate_C4"] = []
...
async def test_acquire_graph_resources_occupied_runway():
    ...
    state.global_simulation_state.registry["Runway_09R"] = ["HAWAIIAN_50"] # Occupied!
...
async def test_acquire_graph_resources_not_occupied_runway():
    ...
    state.global_simulation_state.registry["Runway_09R"] = []
    ...
    assert "DELTA_101" in state.global_simulation_state.registry["Runway_09R"]
